...
\begin{chapter}{Density Functional Theory \label{chap:dft}}
   ...
   \begin{section}{xc-potential \label{sec:xcpot}}
      ...
      \begin{equation} \label{eq:tdvxc-der}
         \frac{\delta A_\mathrm{xc}[n]}{\delta n(\mathbf{r},t)} = v_\mathrm{xc}[n](\mathbf{r},t).
      \end{equation}
      ...
      The simplest explicit density fucntional is the local density approximation~\cite{ks-eq}. Taking
      ...
      \begin{subsection}{Optimized Potential Method \label{sec:opm}}
         ...
         implicit density functional. Then using the chain rule 
   ...
   \begin{itemize}
      ...
      \item OPM: DTF~\cite{opm1, opm2} other derivations:~\cite{opm3, opm4, opm5, opm-rev} and
         ...
         OPM: add correlation~\cite{opm5, tdopm}
