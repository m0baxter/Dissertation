...
\begin{chapter}{Introduction \label{chap:intro}}
   ...
   Another alternative is the classical trajectory Monte Carlo method (\textsc{ctmc})~\cite{ctmcRev}. In
   ...
   \textsc{dft} background is presnented in Chap.~\ref{chap:dft}. Chapter~\ref{chap:p-he2p-he} of this
