...
\begin{chapter}{\texorpdfstring{He\textsuperscript{+}}{He+}-He Collisions \label{chap:hephe}}
   ...
   \begin{section}{Calculating the x-Potential \label{sec:pot}}
      ...
      designed precisely for such situations\footnote{The details of \texttt{DIAMOL} may be found
      in~\cite{diamol} and were provided by the authors via private communication}. If at each time-step
      of the \texttt{BGM} (the software package which implements the \textsc{bgm}) the time-dependent
      \textsc{ks}-orbitals, $\varphi_{\sigma j}(\mathbf{r},t)$ is fed into \texttt{DIAMOL} the
      exchange-potential, $v^{\sigma}_\mathrm{x}[\varphi_{\sigma j};t]$, may be calculated at each $t$,
      effectively giving one the time-dependent exchange-potential
      $v^{\sigma}_\mathrm{x}[\varphi_{\sigma j}](t)$.
   ...
   \begin{section}{Results I Guess? \label{sec:hephe-disc}}
      ...
      \begin{subsection}{Results \label{sec:hephe-res}}
         ...
         \begin{figure}[t]
            ...
            \caption[Total Cross section for single ionization of the target in He\textsuperscrit{+}-He
                     collisions.]
         ...
         \begin{figure}[t]
            ...
            \caption[Total Cross section for single ionization of the projectile in
                     He\textsuperscrit{+}-He collisions.]
         ...
         \begin{figure}[t]
            ...
            \caption[Total Cross section for single capture to the projectile He\textsuperscrit{+}-He
                     collisions.]
         ...
         \begin{figure}[t]
            ...
            \caption[Total Cross section for double ionization of the target in He\textsuperscrit{+}-He
                     collisions.]
         ...
         \begin{figure}[t]
            ...
            \caption[Total Cross section for simultaneous single ionization of the target and projectile
                     in He\textsuperscrit{+}-He collisions.]
         ...
         \begin{figure}[t]
            \begin{minipage}{.49\linewidth}
               ...
               \caption[Total Cross section for capture to the target in He\textsuperscrit{+}-He
                        collisions.]
                       {Total Cross section for capture to the target in He\textsuperscrit{+}-He
                        collisions.
                        Theoretical: p\textsc{etf} response (solid line), n\textsc{etf} response (dotted
                                  line),
                                  p\textsc{etf} no response (dashed line), and n\textsc{etf} no response
