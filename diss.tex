...
\begin{chapter}{Introduction \label{chap:intro}}
   ...
   one-particle density \textsc{tddft} has been successfully applied to a wide range of problems
   {\color{red}{list applications and refssss}}.
