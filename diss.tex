...
\begin{chapter}{ Title\dots \label{chap:p-he2p-he}} %nnnote: change this title.
   ...
   \begin{section}{Approximating Observable Functionals \label{sec:phe2p-obs}}
      ...
      centre, hydrogen or helium, with no, one, or two electrons bound. Labeling the various densities
   ...
   \begin{section}{Calculation Details \label{sec:phe2p-det}}
      ...
      at $t_f$ by considering there seperation in function space between them. Owing to the fact that
...
\begin{chapter}{\texorpdfstring{He\textsuperscript{+}}{He+}-He Collisions \label{chap:hephe}}
   ...
   system, one where a positively-charged projectile is incedent on a heloum like target. The situation
   was then complicated by allowing the projectile to be negative, thus forcing one to consider elctron
   ...
   previous chapter is no longer applicable, the full spin-dependenent \textsc{tdks} presented in
   Eq.~\eqref{eq:tdks}.
