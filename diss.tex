...
\begin{chapter}{\texorpdfstring{He\textsuperscript{+}}{He+}-He Collisions \label{chap:hephe}}
   ...
   \begin{section}{Calculating the x-Potential \label{sec:pot}}
      ...
      cancellation of the self interaction present in the Hartree potential. A collection of
      visualizations of this process may be found in Appendix \ref{sec:visual}.
...
\begin{appendices}
   ...
   \begin{chapter}{Visualizing the Time-dependent Potential \label{sec:visual}}
      ...
      the p\textsc{etf} model. In this way one can more easily under stand the appearance and time
      evolution of $v_\mathrm{ee}^\sigma$. For example for $v_\mathrm{ee}^\uparrow$ contain a single
      peak. This is due to the exact cancelation of self interaction that is present on the projectile
      centre where initially only one electron resides.
