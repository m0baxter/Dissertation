...
\documentclass[letterpaper, 11 pt, twoside]{report}
...
\begin{appendices}
   ...
   \begin{chapter}{Computational Aspects \label{chap:calcdeets}}
      ...
      employs either an Adams method (predictor-corrector) in the case of stiff systems or a backward
      differentiation formula in the case of non-stiff systems. In this way the \textsc{ks}-orbitals are
