...
\begin{chapter}{\texorpdfstring{He\textsuperscript{+}}{He+}-He Collisions \label{chap:hephe}}
   ...
   \begin{section}{Results I Guess? \label{sec:hephe-disc}}
      ...
      \begin{subsection}{Results \label{sec:hephe-res}}
         ...
         refers simply to the respnse versions.
   ...
   \begin{itemize}
      ...
      \item Schenk and Kirchner or just Schenk?

      \item discuss difference between response and no-response~\cite{microresp}

      \item numerical derivatives~\cite{numdiff1, numdiff2}
