...
\begin{chapter}{\texorpdfstring{He\textsuperscript{+}}{He+}-He Collisions \label{chap:hephe}}
   ...
   \begin{section}{Final-state analysis \label{sec:hephe-det}}
      ...
      Expressions similiar to Eq.~\eqref{eq:prob-iem} may be constructed in this context. The key to the
      derivation comes from expressing the single-particle probabilities in terms of the transition
      amplitudes, for example, $p_T$ may be written
      %
   ...
   \begin{section}{Results \label{sec:hephe-disc}}
      ...
      \begin{subsection}{Results \label{sec:hephe-res}}
         ...
         whether the lower result is desirable or not difficult. The only other channeli, apart from
